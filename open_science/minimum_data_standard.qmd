...
**[Read the full paper in *Scientific Data* {{< iconify bi box-arrow-up-right >}}](https://doi.org/10.1038/s41597-025-05332-x)**

---

Rapid and transparent data sharing is critical for responding to threats from wildlife diseases. However, the value of shared data is often limited by a lack of standardisation, with many datasets—especially those with negative results—being difficult to reuse.
...
* **Host Information:** Standardised taxonomy and sampling details.
...
![The Pathogen Harmonised Observatory (PHAROS). Image obtained from https://pharos.viralemergence.org/](images/pharos.jpg)