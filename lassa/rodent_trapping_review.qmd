...
author: 
  ...
  - name: "Richard Kock"
    affiliation: The Royal Veterinary College
categories: [Rodent, Ecology, Zoonosis, West Africa, Published, Peer-Reviewed, Open Data]
image: images/rodent_trapping_preview.png
bibliography: rodent_trapping.bib
date: 2023-01-27
citation:
  type: article-journal
  container-title: "PLOS NTD"
...
Currently all data is accessible at an archived [Zenodo repository] (https://zenodo.org/badge/DOI/10.5281/zenodo.7416054) and on [GitHub](https://github.com/DidDrog11/scoping_review).

## Pre-print

This work is now peer reviewed, a pre-print has been deposited on [BioRxiv](https://www.biorxiv.org/content/10.1101/2022.08.30.505792v2.full).

## Publication

This work has been published in [PLOS Neglected Tropical Diseases](https://doi.org/10.1371/journal.pntd.0010772) following peer review. As part of the journals open peer-review process all peer review comments and author respones have been made available on the [Peer review](https://journals.plos.org/plosntds/article/peerReview?id=10.1371/journal.pntd.0010772) tab of the article.
