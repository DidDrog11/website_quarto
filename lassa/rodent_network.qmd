...
This manuscript is published in the [*American Journal of Tropical Medicine and Hygiene*](https://doi.org/10.4269/ajtmh.25-0120). Feel free to get in touch if you cannot access it from the publishers website. Alternatively the preprint **[Contact networks of small mammals highlight potential transmission foci of Mammarenavirus lassaense](https://doi.org/10.1101/2025.02.25.639449)** is available from *bioRxiv*.

## Conference Presentations

This work has been presented at multiple international conferences.

#### Lassa Fever International Conference 2025

Presented at the 2nd Lassa Fever International Conference (ECOWAS) in Abidjan, Côte d'Ivoire.

{{< pdf files/rodent_network/oral_presentation_2.pdf width=100% height=500 >}}

#### ASTMH Annual Conference 2023

Presented at the American Society for Tropical Medicine and Hygiene annual conference in Chicago, USA.
