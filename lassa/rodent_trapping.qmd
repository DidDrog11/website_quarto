...
This manuscript has been submitted to the *Journal of Animal Ecology*. The pre-peer reviewed version is available from [*ecoevoRxiv*](https://ecoevorxiv.org/repository/view/8476/).

## Data availability and draft manuscript

Data are available in the project's GitHub [repository](https://github.com/DidDrog11/land-use-lassa-hosts).
