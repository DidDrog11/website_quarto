...
categories: [Rodent, Ecology, Zoonosis, Lassa Fever, Preprint, Landuse Change]
...
This manuscript is published in the [*Journal of Animal Ecology*](https://doi.org/10.1111/1365-2656.70187). The pre-peer reviewed version, [Land use gradients drive spatial variation in Lassa fever host communities in the Eastern Sierra Leone](https://ecoevorxiv.org/repository/view/8476/) is available from *ecoevoRxiv*.

## Data and Code Availability

Data and code are available in the project's GitHub [repository](https://github.com/DidDrog11/land-use-lassa-hosts) and archived on [PHAROS](https://pharos.viralemergence.org/projects/?prj=prjyg91YQvrdk).

## EEID 2022 presentation

I presented data from the first year of trapping at the 2022 Ecology and Evolution of Infectious Diseases conference, the [slides are available here](files/david_simons_EEID.pdf) and the talk is embedded below.
