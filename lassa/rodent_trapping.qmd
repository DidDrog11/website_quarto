...
This manuscript is currently under review at the *Journal of Animal Ecology*. The pre-peer reviewed version, [Land use gradients drive spatial variation in Lassa fever host communities in the Eastern Sierra Leone](https://ecoevorxiv.org/repository/view/8476/) is available from *ecoevoRxiv*.
