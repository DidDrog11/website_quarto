...
A draft of the web-based application that will accompany the project has been developed and is available [here](https://diddrog11.shinyapps.io/arenavirus_hantavirus_app/) (n.b data extraction has only been performed for a pilot of 9 studies).
